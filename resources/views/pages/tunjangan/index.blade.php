                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm  d-flex align-items-center justify-content-end mx-3 gap-2">
                                <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                    ...
                                    <a type="button" class="btn btn-success" href="{{ route('tunjangan.cetak') }}">Cetak</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        ...
                                        <a href="{{ route('tunjangan.destroy', ['id' => $items->id]) }}"
                                            class="text-secondary font-weight-bold text-md" data-toggle="tooltip"
                                            data-original-title="Delete tunjangan" data-confirm-delete="true">
                                            <i class="fa-solid fa-trash"></i>
                                        </a>
                                    </td>
                                </tr>
                                {{-- Modal Update Data tunjangan --}}
                                                ...
                                                <div class="card card-plain">
                                                    ...
                                                    <div class="card-body">
                                                        <form role="form text-left"
                                                            action="{{ route('tunjangan.update', ['id' => $items->id]) }}"
                                                            method="POST">
                                                            @method('PUT')
                                                            @csrf
                                                            ...
                                                            <div
                                                                class="input-group input-group-outline my-3 {{ $items->nama_tunjangan ? 'is-filled' : '' }}">
                                                                <label class="form-label">Nama Tunjangan</label>
                                                                <input type="varchar" class="form-control" name="nama_tunjangan"
                                                                    onfocus="focused(this)" value="{{ $items->nama_tunjangan }}"
                                                                    onfocusout="defocused(this)">
                                                            </div>
                                                            <div
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                        <div class="modal-content">
                            <div class="modal-body p-0">
                                <div class="card card-plain">
                                    <div class="card-header pb-0 text-left">
                                        <h5 class="">Tambah Tunjangan</h5>
                                    </div>
                                    <div class="card-body">
                                        <form role="form text-left" action="{{ route('tunjangan.store') }}" method="POST">
                                            @csrf
                                            <div class="input-group input-group-outline my-3">
